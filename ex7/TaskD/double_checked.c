...
Got singleton 0x7fc3a4000f70:{1 0 0 0}
Got singleton 0x7fc3a4000f70:{1 0 0 0}
Got singleton 0x7fc3a4000f70:{1 0 0 0}
Got singleton 0x7fc3a4000f70:{1 0 0 0}
Got singleton 0x7fc3a4000f70:{1 0 0 0}

A different thread is run when an initialization is ongoing
causing the other thread to output a different value than
it is supposed to
